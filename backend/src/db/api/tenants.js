...
module.exports = class TenantsDBApi {
  static async create(data, options) {
    ...
    await tenants.setOrganization(currentUser.organization.id || null, {
      transaction,
    });

    await tenants.setUsers(data.users || [], {
      transaction,
    });
  ...
  static async findBy(where, options) {
    ...
    output.users = await tenants.getUsers({
      transaction,
    });

    output.organization = await tenants.getOrganization({
      transaction,
    });
